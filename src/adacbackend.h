...
public:
  ...
  Q_INVOKABLE virtual void getTrafficData(QString country, QString streetName, bool showConstructionSites);
...
protected:
  ...
  QNetworkReply *executePostRequest(const QUrl &url, const QString country, const QString streetName, bool showConstructionSites);
